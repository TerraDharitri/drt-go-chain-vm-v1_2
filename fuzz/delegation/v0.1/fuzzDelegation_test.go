...
import (
	...
	fuzzutil "github.com/TerraDharitri/drt-go-chain-vm-v1_2/fuzz/util"
...
func newExecutorWithPaths() *fuzzDelegationExecutor {
	fileResolver := mc.NewDefaultFileResolver().
		ReplacePath(
			"delegation.wasm",
			filepath.Join(getTestRoot(), "delegation/v0_1_latest_full/output/delegation_latest_full.wasm")).
		ReplacePath(
			"auction-mock.wasm",
