(module
  ...
  (import "env" "getNumArguments" (func (;7;) (type 5)))
  (import "env" "smallIntStorageLoadUnsigned" (func (;8;) (type 6)))
  (import "env" "smallIntStorageStoreUnsigned" (func (;9;) (type 7)))
  (import "env" "bigIntNew" (func (;10;) (type 8)))
  (import "env" "bigIntStorageLoadUnsigned" (func (;11;) (type 4)))
  (import "env" "bigIntSetUnsignedBytes" (func (;12;) (type 9)))
  (import "env" "bigIntGetUnsignedArgument" (func (;13;) (type 3)))
  ...
  (func (;34;) (type 9) (param i32 i32 i32)
    ...
    local.get 2
    call 63)
  (func (;35;) (type 12) (param i32 i32 i32 i32) (result i32)
    local.get 0
    local.get 1
    local.get 2
    local.get 3
    call 36)
  (func (;36;) (type 12) (param i32 i32 i32 i32) (result i32)
    (local i32)
    block  ;; label = @1
      local.get 3
      local.get 2
  ...
  (func (;90;) (type 2) (param i32) (result i32)
    ...
    drop
    local.get 0)
  (func (;91;) (type 14) (param i32) (result i64)
    local.get 0
    i32.load
    local.get 0
    i32.load offset=4
  ...
  (func (;107;) (type 3) (param i32 i32)
    ...
    i32.add
    i32.const 0
    i32.load offset=1049113 align=1
    i32.store align=1
    local.get 3
    i32.const 0
    i64.load offset=1049106 align=1
    i64.store align=1
    local.get 2
    i32.const 11
    i32.store offset=24
      ...
      block  ;; label = @2
        block  ;; label = @3
          ...
          block  ;; label = @4
            ...
            i32.const 0
            i64.const 0
            i64.store offset=1049308 align=1
            i32.const 0
            i64.const 0
            i64.store offset=1049300 align=1
            i32.const 0
            i64.const 0
            i64.store offset=1049292 align=1
            i32.const 0
            i64.const 0
            i64.store offset=1049284 align=1
            block  ;; label = @5
              local.get 5
              i32.eqz
              br_if 0 (;@5;)
  ...
  (func (;114;) (type 13)
    (local i32 i32 i32 i64 i32 i32 i32 i64 i32)
    global.get 0
    i32.const 80
    i32.sub
    local.tee 0
  ...
  (func (;127;) (type 0) (param i32 i32 i32 i32)
    ...
    i32.add
    global.set 0)
  (func (;128;) (type 17) (param i32 i32 i32 i32 i32) (result i32)
    (local i32 i32)
    global.get 0
    i32.const 16
    i32.sub
    ...
    global.set 0
    local.get 6)
  (func (;129;) (type 17) (param i32 i32 i32 i32 i32) (result i32)
  ...
  (func (;140;) (type 4) (param i32 i32 i32) (result i32)
    ...
    local.get 0)
  (func (;141;) (type 4) (param i32 i32 i32) (result i32)
    (local i32)
    block  ;; label = @1
      local.get 2
      i32.eqz
  ...
  (global (;2;) i32 (i32.const 1050344))
  (export "memory" (memory 0))
  (export "init" (func 114))
  (export "ping" (func 115))
  (export "pong" (func 117))
  (export "pongAll" (func 118))
  (export "getUserAddresses" (func 119))
  (export "getPingAmount" (func 120))
  (export "getDeadline" (func 121))
  (export "getActivationTimestamp" (func 122))
  (export "getMaxFunds" (func 123))
  (export "getUserStatus" (func 124))
  (export "pongAllLastUser" (func 125))
  (export "callBack" (func 126))
  (export "__data_end" (global 1))
  (export "__heap_base" (global 2))
  (elem (;0;) (i32.const 1) func 131 132 133 134 138 127 135 136)
  (data (;0;) (i32.const 1048576) "capacity overflowinterruptedcompletedbig uint as_bytes exceed target sliceallocation errorpanic occurredbad H256 lengthinput too shortassertion failed: mid <= self.len()argument decode error (): wrong number of argumentsfunction does not accept DCDT paymentinvalid valueinput too longstorage decode error: _address_to_id_count_id_to_addressmax_fundsactivation_timestampdeadlineping_amountthe payment must match the fixed sumsmart contract not active yetdeadline has passedsmart contract fullalready withdrawncan only ping onceuseruser_statuscan't pong, never pingedunknown userpongcan't withdraw before deadlinepong_all_last_useropt_activation_timestampuser_id\01\00\00\00\00\00\00\00\01\00\00\00\02\00\00\00\03\00\00\00\04\00\00\00\05\00\00\00\04\00\00\00\04\00\00\00\06\00\00\00\07\00\00\00\08\00\00\00")
  (data (;1;) (i32.const 1049284) "uuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuu"))
