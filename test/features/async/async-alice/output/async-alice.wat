(module
  ...
  (import "env" "getNumArguments" (func (;6;) (type 7)))
  (import "env" "smallIntGetUnsignedArgument" (func (;7;) (type 8)))
  (import "env" "smallIntStorageStoreSigned" (func (;8;) (type 9)))
  (import "env" "checkNoPayment" (func (;9;) (type 10)))
  (import "env" "storageStore" (func (;10;) (type 11)))
  (import "env" "getOriginalTxHash" (func (;11;) (type 6)))
  (import "env" "smallIntGetSignedArgument" (func (;12;) (type 8)))
  (import "env" "bigIntUnsignedByteLength" (func (;13;) (type 3)))
  (import "env" "bigIntGetUnsignedBytes" (func (;14;) (type 1)))
  (import "env" "asyncCall" (func (;15;) (type 2)))
  ...
  (func (;21;) (type 12) (param i32 i32 i32)
    ...
    local.get 2
    call 125)
  (func (;22;) (type 11) (param i32 i32 i32 i32) (result i32)
    local.get 0
    local.get 1
    local.get 2
    local.get 3
    call 23)
  (func (;23;) (type 11) (param i32 i32 i32 i32) (result i32)
    (local i32)
    block  ;; label = @1
      local.get 3
      local.get 2
  ...
  (func (;37;) (type 4) (param i32 i32)
    ...
    call 2
    unreachable)
  (func (;38;) (type 2) (param i32 i32 i32 i32)
    (local i32)
    global.get 0
    i32.const 48
    i32.sub
  ...
  (func (;60;) (type 4) (param i32 i32)
    (local i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i64 i64 i32 i32 i32)
    global.get 0
    i32.const 128
    i32.sub
    local.tee 2
  ...
  (func (;72;) (type 3) (param i32) (result i32)
    ...
    global.set 0
    local.get 0)
  (func (;73;) (type 14) (param i32 i32 i32 i32 i32)
  ...
  (func (;96;) (type 10)
    ...
    call 36
    unreachable)
  (func (;97;) (type 7) (result i32)
    i32.const 32
    i32.const 1
    call 24)
  (func (;98;) (type 14) (param i32 i32 i32 i32 i32)
    block  ;; label = @1
      block  ;; label = @2
        local.get 4
        local.get 3
  ...
  (func (;122;) (type 6) (param i32)
    ...
    block  ;; label = @1
      ...
      i32.const 0
      i64.const 0
      i64.store offset=1049248 align=1
      i32.const 0
      i64.const 0
      i64.store offset=1049240 align=1
      i32.const 0
      i64.const 0
      i64.store offset=1049232 align=1
      i32.const 0
      i64.const 0
      i64.store offset=1049224 align=1
      block  ;; label = @2
        local.get 1
        i32.eqz
        br_if 0 (;@2;)
  ...
  (func (;126;) (type 2) (param i32 i32 i32 i32)
    ...
    i32.add
    global.set 0)
  (func (;127;) (type 16) (param i32 i32 i32 i32 i32) (result i32)
    (local i32 i32)
    global.get 0
    i32.const 16
    i32.sub
    ...
    global.set 0
    local.get 6)
  (func (;128;) (type 16) (param i32 i32 i32 i32 i32) (result i32)
    (local i32 i32 i32 i32 i32 i32 i32)
    local.get 1
    i32.const -1
    i32.add
  ...
  (global (;2;) i32 (i32.const 1050284))
  (export "memory" (memory 0))
  (export "init" (func 83))
  (export "forwardToOtherContract" (func 84))
  (export "forwardToOtherContractWithCallback" (func 89))
  (export "messageOtherContract" (func 91))
  (export "messageOtherContractWithCallback" (func 94))
  (export "callBack" (func 96))
  (export "__data_end" (global 1))
  (export "__heap_base" (global 2))
  (elem (;0;) (i32.const 1) func 99 102 108 109 110 111 112 113 118 114 130 131 132 133 137 126 134 135)
  (data (;0;) (i32.const 1048576) "capacity overflowbad H256 lengthargument decode error (): wrong number of argumentsfunction does not accept DCDT paymentDCDTTransferstorage decode error: input too longpayMepayMeWithResultmessageMeother_contractpayCallbackmessage_callbackcallback_infono callback function with that name exists in contractcall_result_call_resultcalee_addresscalled `Option::unwrap()` on a `None` value:      {  {\0a\02\00\00\00\0c\00\00\00\04\00\00\00\03\00\00\00\04\00\00\00\05\00\00\00,\0a\00\00\02\00\00\00\04\00\00\00\04\00\00\00\06\00\00\00\07\00\00\00\08\00\00\00} }()LayoutErrorprivatecalled `Result::unwrap()` on an `Err` value\00\00\09\00\00\00\00\00\00\00\01\00\00\00\0a\00\00\00big uint as_bytes exceed target sliceallocation errorpanic occurred\00\0b\00\00\00\00\00\00\00\01\00\00\00\0c\00\00\00\0d\00\00\00\0e\00\00\00\0f\00\00\00\04\00\00\00\04\00\00\00\10\00\00\00\11\00\00\00\12\00\00\00")
  (data (;1;) (i32.const 1049224) "uuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuu"))
